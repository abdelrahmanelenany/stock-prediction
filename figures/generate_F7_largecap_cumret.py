"""Generate Figure F7 — Large-Cap Cumulative Returns with Drawdown Overlay."""
...
GROSS_CSV = os.path.join(REPORTS, "large_cap_daily_returns_gross.csv")
NET_CSV   = os.path.join(REPORTS, "large_cap_daily_returns_net_5bps.csv")
...
ax_top.set_title("Large-Cap Universe — Cumulative Returns (Gross and Net, 5 bps)")
...
# ── Save ───────────────────────────────────────────────────────────────────────
pdf_path = os.path.join(OUT_DIR, "F7_largecap_cumret.pdf")
png_path = os.path.join(OUT_DIR, "F7_largecap_cumret.png")
